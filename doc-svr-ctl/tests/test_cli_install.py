...
class TestCLIEntryPoint:
    ...
    def test_cli_function_importable(self):
        """T012: Verify cli() function can be imported from src.cli."""
...
class TestCLIVersionFlag:
    ...
    def test_version_flag_returns_version(self):
        ...
        assert result.exit_code == 0, f"--version should exit with 0, got {result.exit_code}"
        assert "1.0.0" in result.output, f"Should show version 1.0.0, got: {result.output}"
