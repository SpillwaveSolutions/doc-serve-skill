...
from doc_svr_ctl.commands.init import init_command
from doc_svr_ctl.commands.list_cmd import list_command
from doc_svr_ctl.commands.start import start_command
from doc_svr_ctl.commands.stop import stop_command
...
class TestListCommand:
    ...
    def test_list_no_instances(self, runner: CliRunner) -> None:
        ...
        with patch("doc_svr_ctl.commands.list_cmd.get_registry", return_value={}):
    ...
    def test_list_with_stale_instance(
        ...
        with (
            patch(
                "doc_svr_ctl.commands.list_cmd.get_registry",
                return_value=registry,
            ),
            patch(
                "doc_svr_ctl.commands.list_cmd.is_process_alive",
                return_value=False,
            ),
            patch("doc_svr_ctl.commands.list_cmd.save_registry"),
        ):
